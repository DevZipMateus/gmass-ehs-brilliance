      ...
      <div className="container px-4 sm:px-6 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 xs:mb-10 sm:mb-12 md:mb-16">
            <span className="inline-flex items-center gap-1.5 xs:gap-2 px-3 py-1 xs:py-1.5 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white rounded-full text-xs sm:text-sm font-semibold mb-3">
          ...
          {/* Instagram Card */}
          <div className="bg-card rounded-2xl sm:rounded-3xl p-4 xs:p-6 sm:p-8 md:p-10 shadow-card border border-border/50 text-center">
            {/* Instagram Icon with Gradient */}
            <div className="w-16 xs:w-20 sm:w-24 md:w-28 h-16 xs:h-20 sm:h-24 md:h-28 mx-auto mb-4 xs:mb-6 sm:mb-8 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] flex items-center justify-center shadow-lg">
              <Instagram className="w-8 xs:w-10 sm:w-12 md:w-14 h-8 xs:h-10 sm:h-12 md:h-14 text-white" />
            </div>
            ...
            <div className="flex flex-col xs:flex-row flex-wrap justify-center gap-3 xs:gap-4 sm:gap-6 md:gap-8 mb-4 xs:mb-6 sm:mb-8">
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                ...
                <span className="text-xs xs:text-sm sm:text-base">Conteúdo exclusivo</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                <MessageCircle className="w-4 xs:w-5 h-4 xs:h-5 text-[#833ab4]" />
                <span className="text-xs xs:text-sm sm:text-base">Dicas de segurança</span>
              </div>
            </div>
            ...
            <Button
              asChild
              size="lg"
              className="w-full xs:w-auto bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white hover:opacity-90 transition-opacity border-0"
            >
              <a
                href={INSTAGRAM_URL}
                target="_blank"
          ...
          <div className="grid grid-cols-1 xs:grid-cols-3 gap-3 xs:gap-4 sm:gap-6 mt-6 xs:mt-8 sm:mt-10 md:mt-12">
            <div className="bg-card rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 text-center border border-border/50 hover:shadow-card transition-shadow">
